...
onMounted(() => {
  ...
  text.beginPath();
  text.moveTo(20, 20);
  text.quadraticCurveTo(20, 100, 200, 20);
  text.stroke();
});
...
//     ctx.fill();
//     var lineGradient2 = ctx.createLinearGradient(290, 201, 285, 216);
//     lineGradient2.addColorStop(0, '#f1dad2');
//     lineGradient2.addColorStop(1, '#e8d8c9');
//     ctx.fillStyle = lineGradient2;
//     ctx.beginPath();
//     ctx.moveTo(312, 205);
